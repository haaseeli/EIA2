var A12;
(function (A12) {
    class Einfacheinenkreiszeichnen extends A12.Fish {
        draw() {
            ...
            A12.crc.stroke(chantal);
            A12.crc.strokeStyle = "purple";
            A12.crc.fill(chantal);
            A12.crc.fillStyle = "pink";
            super.draw();
        }
        move() {
            this.x += this.dx;
    ...
    A12.Einfacheinenkreiszeichnen = Einfacheinenkreiszeichnen;
})(A12 || (A12 = {}));
